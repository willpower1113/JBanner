...
internal class JBannerAdapter(manager: FragmentManager, var mData: List<Fragment>) : FragmentPagerAdapter(manager) {

    override fun getCount(): Int {
        return if (mData.isEmpty()) 0 else Int.MAX_VALUE
    }
